...
namespace Reporter_Client.Sensors
{
    public class AnalogSensor : AnalogBase
    {
        ...
        public event Action<object, ValueChangedArg> ValueChanged;
        ...
        public double CurrentValue
        {
            ...
            set
            {
                ...
                {
                    _currentValue = value;
                    ValueChanged?.Invoke(this, new ValueChangedArg(Id, value));
                }
            }
        }
    ...
    public class ValueChangedArg
    {
        public int Id { get; set; }
        public double Value { get; set; }
        public ValueChangedArg(int index, double value)
        {
            Value = value;
            Id = index;
        }
