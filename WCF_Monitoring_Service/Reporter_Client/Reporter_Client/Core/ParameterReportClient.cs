...
{
    public class ParameterReportClient
    {
        public static int count;
        private Thread _mainThread;
        private ChannelFactory<IParameterReport> _factory;
        private IParameterReport _proxy;
        private SensorSimulator _simulator;

        public ParameterReportClient()
        {
            _factory = new ChannelFactory<IParameterReport>("NetTcpBinding_IParameterReport");
